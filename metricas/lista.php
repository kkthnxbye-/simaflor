...
<? endif; ?> </div>
        ...
        <div class="portlet-content">
            ...
            <div class="user_tit" id="div_bus1">
                ...
                <form name="busqueda" id="busqueda" method="post"  action="lista.php" >Campo
                    ...
                    <input type="hidden" name="page" id="page" value="metricas" />				
            ...
            <div class="btn_right">
                ...
                <button style="float: left;margin-right: 5px" class="btn btn-grey" onclick="location.href='metricas_crear.php'">Nueva</button>
...
<?php foreach ($metricasV as $metricas) { ?>
                        <tr class="odd gradeX">
                            ...
                            <td>
    <? if ($modificar == 1) { ?>
                                    <a href="metricas_editar.php?id=<?php echo $metricas->getId(); ?>" class="btn_editar">
    ...
    <? } ?>
                                ...
                                <a onClick="return confirma(this)" href="../php/action/metricasDelete.php?id=<?php echo $metricas->getId(); ?>" class="btn_black">
