...
$TiposMaterialVegetals = $TiposMaterialVegetalDAO->gets($_SESSION['campo'], $_SESSION['tipo_b'], $_SESSION['valor']);
$total = $TiposMaterialVegetalDAO->total($_SESSION['campo'], $_SESSION['tipo_b'], $_SESSION['valor']);
?>
<div id="content" class="xfluid">		
    <div class="portlet x12">
        ...
        <div class="portlet-content">
            ...
            <div class="user_tit">
                <form onSubmit="return valida_cod()" name="busqueda" action="TiposMaterialVegetalList.php" id="busqueda" method="post">
                    ...
                    <input type="hidden" name="page" value="TiposMaterialVegetal">
                    Valor
            ...
            <div style="display:inline"  style="padding-left:10px">
                ...
                <a href="TiposMaterialVegetalList.php?page_bus=2" class="btn_editar l">
            ...
            <div class="btn_right">
                ...
                <button style="float: left;margin-right: 5px" class="btn btn-grey" onclick="location.href='TiposMaterialVegetalAdd.php'">Nuevo</button>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" rel="datatable" id="example">
                ...
                <tbody>
                    <?php if ($total > 0): ?>
                        <?php foreach ($TiposMaterialVegetals as $TiposMaterialVegetal): ?>
                            <tr class="odd gradeX">
                                <td><?= $TiposMaterialVegetal->getNombre() ?></td>
                                <td class="center">
                                    <? if ($modificar != 0) { ?> 
                                        <a href="TiposMaterialVegetalEdit.php?id=<?= $TiposMaterialVegetal->getId() ?>" class="btn_editar">
                                            <div class="icon_botn"><img src="../images/editar.png" width="22" height="23" /></div>Editar</a>
                                    <? } ?> 
                                    <a onClick="return confirma(this)" href="../php/action/TiposMaterialVegetalDelete.php?id=<?= $TiposMaterialVegetal->getId() ?>" class="btn_black">
