        ...
        <div class="portlet-content">
            ...
            <div class="user_tit">
                <form name="busqueda" action="lista.php" id="busqueda" method="post">
                    ...
                    <input type="hidden" name="page" id="page" value="estadosfumigacion" />
            ...
            <div class="btn_right">
                ...
                <button style="float: left;margin-right: 5px" class="btn btn-grey" onclick="location.href='estadofumigacion_crear.php'">Nuevo</button>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" rel="datatable" id="example">
                ...
                <tbody>
                    <?php foreach ($estadosfumigacion as $estadofumigacion) { ?>
                        <tr class="odd gradeX">
                            <td><?php echo $estadofumigacion->getId(); ?></td>
                            <td><?php echo $estadofumigacion->getNombre() ?></td>
                            <td>

                                <? if ($modificar == 1) { ?>
                                    <a href="estadofumigacion_editar.php?id=<?php echo $estadofumigacion->getId() ?>"class="btn_editar">
                                ...
                                <a onClick="return confirma(this)" href="../php/action/estadofumigacion_eliminar.php?id=<?php echo $estadofumigacion->getId(); ?>"class="btn_black">
