      ...
      <div class="portlet-content">
         ...
         <div class="portlet x6">
            ...
            <div class="portlet-content">
               ...
               <script>
                     function validado(){
                        if($('#id_cliente').val() != 0 && $('#id_proveedor').val() != 0){
                           return true;
                        }else{
               ...
               <form action="../php/action/pedido_add.php" method="post" class="form label-inline" onsubmit="return validado();">
                  ...
                  <div class="field">
                     ...
                     <input id="cliente" name="cliente" size="50" type="text" class="medium" autocomplete="off" onkeyup="buscar_cliente();" />
...
<?php } ?>
                  ...
                  <input type="hidden" name="fincaproduccion" id="fincaproduccion" value="<?php echo $_SESSION['fincaproduccion']; ?>" />                
