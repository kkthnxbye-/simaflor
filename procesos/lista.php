        ...
        <div class="portlet-content">
            ...
            <div class="user_tit">
                <form onSubmit="return valida_cod()" name="busqueda" action="lista.php" id="busqueda" method="post">
                    ...
                    <input type="hidden" name="page" id="page" value="procesos" />
            ...
            <div class="btn_right">
                ...
                <button style="float: left;margin-right: 5px" class="btn btn-grey" onclick="location.href='procesos_crear.php'">Nuevo</button>
...
<!--							<th>id</th>-->
    ...
    <!--                                                        <td><?php //echo $proceso->getId();  ?></td>-->
                            <td><?php echo $proceso->getCodigo(); ?></td>
                            <td><?php echo $proceso->getNombre() ?></td>

                            <td>
                                <? if ($modificar != 0) { ?>
                                    <a href="procesos_editar.php?id=<?php echo $proceso->getId(); ?>" class="btn_editar">
                                ...
                                <a onClick="return confirma(this)" href="../php/action/procesosDel.php?id=<?php echo $proceso->getId(); ?>" class="btn_black">
