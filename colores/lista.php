    ...
    <div class="portlet x12">
        ...
        <div class="portlet-content"><a name="plugin"></a>				
            ...
            <div class="btn_right">
                ...
                <button style="float: left;margin-right: 5px" class="btn btn-grey" onclick="location.href='color_crear.php'">Nuevo</button>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" rel="datatable" id="example">
                ...
                <tbody>
                    <?php foreach ($colores as $color) { ?>
                        <tr class="odd gradeX">
                            <td><?= $color->getId(); ?></td>
                            <td><?php echo $color->getCodigo(); ?></td>
                            <td><?php echo $color->getNombre() ?></td>
                            <td>
                                <? if ($modificar != 0) { ?>
                                    <a href="color_editar.php?id=<?php echo $color->getId(); ?>" class="btn_editar">

                                        <div class="icon_botn"><img src="../images/editar.png" width="22" height="23" /></div> 

                                        Editar</a>
                                <? } ?>
                                <a onClick="return confirma(this)" href="../php/action/color_eliminar.php?id=<?php echo $color->getId(); ?>" class="btn_black">
