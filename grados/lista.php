        ...
        <div class="portlet-content"><a name="plugin"></a>
            ...
            <div class="user_tit">
                <form onSubmit="return valida_cod()" name="busqueda" action="lista.php" id="busqueda" method="post">
                    ...
                    <input type="hidden" name="page" id="page" value="grados" />
            ...
            <div class="btn_right">
                ...
                <button style="float: left;margin-right: 5px" class="btn btn-grey" onclick="location.href='grados_crear.php'">Nuevo</button>
...
<!--							<th>ID</th>-->
    ...
    <!--							<td><?php //echo $grado->getId(); ?></td>-->
                            <td><?php echo $procesosDAO->getById($grado->getIdProceso())->getNombre() ?></td>
                            <td><?php echo $productosDAO->getById($grado->getIdProducto())->getNombre() ?></td>
                            <td><?php echo $grado->getCodigo() ?></td>
                            ...
                            <td>
                                ...
                                <? if ($modificar != 0) { ?>
                                    <a href="grado_editar.php?id=<?php echo $grado->getId(); ?>" class="btn_editar">

                                        <div class="icon_botn"><img src="../images/editar.png" width="22" height="23" /></div>

                                        Editar</a>
                                <? } ?>
                                <a onClick="return confirma(this)" href="../php/action/gradosDel.php?id=<?php echo $grado->getId(); ?>" class="btn_black">
