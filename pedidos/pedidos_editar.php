          ...
          <div class="help"><a href="" class="btn_black">
            ...
            <form action="../php/action/pedido_edit.php" method="post" class="form label-inline">
							...
							<div class="field">
							  ...
							  <input id="cliente" name="cliente" size="50" type="text" class="medium" onkeyup="buscar_cliente();" value="<?php echo $dat_cliente->getNombre()." - ".$dat_cliente->getNit();?>" />
			  ...
			  <div class="field">
							  ...
							  <input id="proveedor" name="proveedor" size="50" type="text" value="<?php echo $dat_proveedor->getNombre()." - ".$dat_proveedor->getNit();?>" class="medium" onkeyup="buscar_proveedor();" />
			  ...
			  <div class="field">
				...
				<label for="type">Producto </label>
								...
								?>
								  <option value="<?php echo $prod->getId();?>" <?php echo $sel;?>><?php echo $prod->getNombre();?></option>
								<?php }?>
								</select>
              ...
              <div class="field">
				...
				<label for="type">Material Vegetal </label>
								...
								$sel="";
								if ($materialv->getId() == $dat_pedido->getMaterialvegetal()){
									$sel="selected";
								}
								?>
								  <option value="<?php echo $materialv->getId();?>" <?php echo $sel;?>><?php echo $materialv->getNombre();?></option>
								<?php }?>
								</select>
