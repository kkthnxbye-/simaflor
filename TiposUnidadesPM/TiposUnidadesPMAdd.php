...
<div id="content" class="xfluid">
    <div class="portlet x12">
        ...
        <div class="portlet-content">
            <form onSubmit="return valida_cod()" action="../php/action/TiposUnidadesPMAdd.php" method="post" class="form label-inline">
                ...
                <div class="field"><label for="lname">Habilitado </label> <input id="habilitado" name="habilitado" type="checkbox" class="medium" value="on" <?php if($_GET['h']=="on"){echo "checked";}?> /></div> 
                <br />
                <div class="buttonrow">
