...
$op = $enrutamientoprocesoDAO->getById($_REQUEST['id']);
        ...
        <div class="portlet-header"><h4><?= $_SESSION['url_'] . " / Editar" ?></h4>
            ...
            <div class="portlet-content">
                ...
                <div class="portlet-content">
                    ...
                    <form action="../php/action/enrutamientoprocesoEdit.php" method="post" class="form label-inline">
                        ...
                        <select name="idFinca" id="idProducto">
                            ...
                            <option value=<?= $finc->getId() ?> <?php if($finc->getId() == $op->getId() ){echo "selected";}?> ><?= $finc->getNombre() ?></option>
<?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <select name="idProducto" id="idProducto">
                            ...
                            <option value=<?= $producto->getId() ?> <?php if($producto->getId() == $op->getIdProducto() ){echo "selected";}?> ><?= $producto->getNombre() ?></option>
<?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <select name="idServicio" id="idServicio">
                            ...
                            <option value=<?= $servicio->getId() ?> <?php if($servicio->getId() == $op->getIdServicio() ){echo "selected";}?> ><?= $servicio->getNombre() ?></option>
<?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <select name="idMaterialesVegetales" id="idMaterialesVegetales">
                            ...
                            <option value=<?= $material->getId() ?> <?php if($material->getId() == $op->getIdMaterialVegetal() ){echo "selected";}?> ><?= $material->getNombre() ?></option>
<?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <select name="idProcesoOrigen" id="idProcesoOrigen">
                            ...
                            <option value=<?= $proceso->getId() ?> <?php if($proceso->getId() == $op->getIdProcesoOrigen() ){echo "selected";}?> ><?= $proceso->getNombre() ?></option>
<?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <select name="idProcesoDestino" id="idProcesoDestino">
                            <option value="0">Seleccione</option>
                            <?php foreach ($procesos as $proceso) : ?>
                            <option value=<?= $proceso->getId() ?> <?php if($proceso->getId() == $op->getIdProcesoDestino() ){echo "selected";}?> ><?= $proceso->getNombre() ?></option>
<?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <select name="idTipoMovimiento" id="idTipoMovimiento">
                            ...
                            <option value=<?= $tipo_movimiento->getId() ?> <?php if($tipo_movimiento->getId() == $op->getIdTipoMovimientoInventario() ){echo "selected";}?> ><?= $tipo_movimiento->getNombre() ?></option>
<?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <label>Si</label><input type="radio" name="generaEtiquetaProduccion" value="si" <?php if($op->getGeneraEtiquetaProduccion() == 1 ){echo "checked";}?> >
                        <label>No</label><input type="radio" name="generaEtiquetaProduccion" value="no" <?php if($op->getGeneraEtiquetaProduccion() == 0 ){echo "checked";}?> >
                    </div>
