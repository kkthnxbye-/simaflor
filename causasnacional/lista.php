...
if ($_SESSION['page'] != "causasnacional") {
...
<div id="content" class="xfluid">
    ...
    <div class="portlet x12">
        ...
        <div class="portlet-header"><h4><?= $miga_de_pan ?></h4> 
        ...
        <div class="portlet-content">
            ...
            <div class="user_tit" id="div_bus1">
                ...
                <form name="busqueda" id="busqueda" method="post"  action="lista.php" >
                    ...
                    <input type="hidden" name="page" id="page" value="causasnacional" />
...
<button style="float: left;margin-right: 5px" class="btn btn-grey" onclick="location.href='causasnacional_crear.php'">Nueva</button>
...
<?php foreach ($causasnacional as $causanacional) { ?>
                        <tr class="odd gradeX">							
                            ...
                            <td>
    <? if ($modificar == 1) { ?>
                                    <a href="causasnacional_editar.php?id=<?php echo $causanacional->getId(); ?>" class="btn_editar">
    ...
    <? } ?>
                                ...
                                <a onClick="return confirma(this)" href="../php/action/causanacional_eliminar.php?id=<?php echo $causanacional->getId(); ?>" class="btn_black">
