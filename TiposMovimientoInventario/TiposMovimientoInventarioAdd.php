...
<div id="content" class="xfluid">
    <div class="portlet x12">
        ...
        <div class="portlet-content">
            <form onSubmit="return valida_cod()" action="../php/action/TiposMovimientoInventarioAdd.php" method="post" class="form label-inline">
                ...
                <div class="field"><label for="lname">Suma</label> <input id="suma" name="suma" size="50" type="checkBox" class="medium" <?php if($_GET['s']=="on"):?>checked<?php endif;?>/></div>
