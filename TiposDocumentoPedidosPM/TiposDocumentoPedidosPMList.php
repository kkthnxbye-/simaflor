...
$TiposDocumentoPedidosPMs = $TiposDocumentoPedidosPMDAO->gets($_SESSION['campo'], $_SESSION['tipo_b'], $_SESSION['valor']);


$total = $TiposDocumentoPedidosPMDAO->total($_SESSION['campo'], $_SESSION['tipo_b'], $_SESSION['valor']);
?>
        ...
        <div class="portlet-content">
            ...
            <div class="user_tit">
                <form onSubmit="return valida_cod()" name="busqueda" action="TiposDocumentoPedidosPMList.php" id="busqueda" method="post">
                    ...
                    <input type="hidden" name="page" value="TiposDocumentoPedidosPM">
                    Valor
