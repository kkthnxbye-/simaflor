...
<div id="content" class="xfluid">
            ...
            <div class="portlet x6">
                ...
                <div class="portlet-content">
                    ...
                    <form action="../php/action/pedido_edit.php" method="post" class="form label-inline">
                        ...
                        <input type="hidden" id="ciclo" name="ciclo" value="0" />
                        <input type="hidden" id="id_cliente" name="id_cliente" value="<?php echo $dat_pedido->getFincacliente(); ?>"  />
                        ...
                        <div class="field">
                            ...
                            <select size="1" class="medium" id="servicio" name="servicio" onchange="getMaterialVegetal(this.value);">
                        ...
                        <div class="field">
                            ...
                            <label for="type">Finca producci&oacute;n  <strong style="color:red">*</strong></label>
    ...
    <script type="text/javascript">
        ...
        function getMaterialVegetal(idServicio){
            ...
            if(idServicio == -10){
                ...
                var idFinca = <?= $_SESSION['fincaproduccion'] ?>;
                if($('#producto').val() == 0){
                    $(function(){  msn.info().mostrar('Por favor haga las selecciones pertinentes de la(s) lista(s).');  });
                    return false;
                }
