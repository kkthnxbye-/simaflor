...
$location = "Location: ../../grados/grados_crear.php";
...
if($codigo == "" || $nombre == "" || $idProducto == "" || $idProceso == ""){
    header($location . "?pd=$idProducto&pc=$idProceso&c=$codigo&n=$nombre&d=$descripcion&er1");
    exit;
}
...
if($grados2 != null){
    header($location . "?pd=$idProducto&pc=$idProceso&n=$nombre&d=$descripcion&er2");
    exit;
}
