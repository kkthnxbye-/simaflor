...
if($IDProducto == 0 || $IDMaterialVegetal == 0 || $IDFincaCliente == 0 || $IDFincaProveedor == 0){
   header("Location: ../../configuracionproveedoresxfincapm/configuracionproveedoresxfincapm_editar.php?id=$id&inf");
   exit;   
}

$configuracionproveedoresxfincapmDAO = new configuracionproveedoresxfincapmDAO();
$configuracionproveedoresxfincapm = $configuracionproveedoresxfincapmDAO->getById($id);
...
$configuracionproveedoresxfincapmDAO->update($configuracionproveedoresxfincapm);
