            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" rel="datatable" id="example">
                ...
                <tbody>
                    <?php foreach ($estadospedido as $estadopedido) { ?>
                        <tr class="odd gradeX">
                            <td><?php echo $estadopedido->getId(); ?></td>
                            <td><?php echo $estadopedido->getNombre() ?></td>
                            <td>
                                <? if ($modificar == 1) { ?>

                                    <a href="estadopedido_editar.php?id=<?php echo $estadopedido->getId() ?>"class="btn_editar">
                                ...
                                <? } ?>
                                <? if ($modificar == 79830283) { ?>
                                    <a onClick="return confirma(this)" href="../php/action/estadopedido_eliminar.php?id=<?php echo $estadopedido->getId(); ?>"class="btn_black">
