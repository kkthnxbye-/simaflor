        ...
        <div class="portlet-content">
            ...
            <div class="user_tit">
                <form name="busqueda" action="lista.php" id="busqueda" method="post">
                    ...
                    <input type="hidden" name="page" id="page" value="operarios" />
            ...
            <div class="btn_right">
                ...
                <button style="float: left;margin-right: 5px" class="btn btn-grey" onclick="location.href='operarios_crear.php'">Nuevo</button>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" rel="datatable" id="example">
                ...
                <tbody>
                    <?php foreach ($operarios as $operario) { ?>
                        <tr class="odd gradeX">
                            <td><?php echo $operario->getId(); ?></td>
                            <td><?php echo $operario->getCodigo(); ?></td>
                            <td><?php echo $operario->getNombre() ?></td>
                            <td><?php echo $gruposOperariosDAO->getById($operario->getIdGrupoOperarios())->getNombre() ?></td>
                            <td><img src="img/<?= $operario->getFoto() ?>" width="200"></td>
                            <td>
                                <? if ($modificar == 1) { ?>
                                    <a href="operarios_editar.php?id=<?php echo $operario->getId(); ?>" class="btn_editar">
                                ...
                                <a onClick="return confirma(this)" href="../php/action/operariosDel.php?foto=<?=$operario->getFoto() ?>&id=<?php echo $operario->getId(); ?>" class="btn_black">
